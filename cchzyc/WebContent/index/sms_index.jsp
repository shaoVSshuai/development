					...
					<div class="row">
						<div class="col-md-12">
							<ul class="clearfix panel panelUl">
		                        <!-- <li class="job-list-item job-list-special jobSpecial" v-for="item in list">
		                            <img src="img/student1.jpg">
		                        </li>
		                        <li class="job-list-item job-list-special job-special" v-for="item in list">
		                            <p class="huawei">
		                                <i class="iconfont">&#xe501;</i>
		                            </p>
		                        ...
		                        <!-- <li class="job-list-item job-list-rig jobSpecial">
		                        ...
		                        <li class="job-list-item jobSpecial">
		                            <img src="img/student2.jpg">
		                        </li> -->
		                    </ul>
						</div>
